...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> validate(String username, String cellNumber) async {
    await _firestore
        .collection('users')
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          onFieldSubmitted: (_) {
                            validate(
                                nameController.text, cellnumberController.text);
                            node.unfocus();
                          },
                          decoration: InputDecoration(
                          ...
                          validator: (value) {
                            ...
                            if (!isNumberUnique) {
                              return 'Number already registered. Try logging in.';
                            }
                          },
                        ),
                      )),
                      ...
                      Container(
                          ...
                          child: Padding(
                              ...
                              child: new ElevatedButton(
                                onPressed: () async {
                                  await validate(nameController.text,
